...
public class JavaApplicationPI extends Application {
    ...
    public void start(Stage stage) throws Exception {
       //  Parent rootD= FXMLLoader.load(getClass().getResource("/view/LoginPage.fxml"));
        //  Parent rootD = FXMLLoader.load(getClass().getResource("/view/Medecin/medicammentListe.fxml"));
    //  Parent rootD = FXMLLoader.load(getClass().getResource("/view/admin/subscription/subscriptionListe.fxml"));
         Parent rootD = FXMLLoader.load(getClass().getResource("/view/Medcecin/AddMedicamment.fxml"));
       // Parent rootD = FXMLLoader.load(getClass().getResource("/view/user/order/CreateOrder.fxml"));
